...
let s:darkgray	=	{	"gui": "#303030",	"cterm": 243	}
...
augroup GENERAL
	autocmd!
	autocmd Syntax * syn keyword NOTE NOTE containedin=ALL
augroup END "General

call s:h("NOTE",			{	"fg": s:cyan					})
call s:h("Normal",			{	"fg": s:white2					})
call s:h("Visual",			{					"bg": s:gray4	})
call s:h("Search",			{	"fg": s:black,	"bg": s:pink2	})
call s:h("CurSearch",		{	"fg": s:black,	"bg": s:yellow	})
...
call s:h("SpecialKey",		{	"fg": s:darkgray					})
call s:h("ColorColumn",		{					"bg": s:black2	})
call s:h("TODO",			{	"fg": s:red3	})
call s:h("Number",			{	"fg": s:white2					})
call s:h("Comment",			{	"fg": s:gray3					})
...
call s:h("vimFuncname",		{	"fg": s:white2					})
...
call s:h("cCharacter",		{	"fg": s:green					})
